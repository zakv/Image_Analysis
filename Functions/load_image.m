...
%   file_name should include the relative path of the file if it is not in
%   the current working directory.  Including the '.mat' extension is
%   optional

pic=load_object(file_name);
pic.set_dir( z_fileparts(fullfile(pwd,file_name)) );
